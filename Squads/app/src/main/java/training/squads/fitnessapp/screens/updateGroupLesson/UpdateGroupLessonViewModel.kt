...
class UpdateGroupLessonViewModel(val database: DatabaseDaoGroupLesson, application: Application): AndroidViewModel(application) {
     ...
     */
    suspend fun saveGroupLessonWithRepository(existingGroupLesson: GroupLesson) {
        repository.updateGroupLesson(existingGroupLesson)
    }
